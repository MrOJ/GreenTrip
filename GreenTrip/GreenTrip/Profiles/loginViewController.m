...
- (IBAction)getLogin:(id)sender {
    ...
    //发起请求
    [manager GET:@"http://192.168.1.123:1210/" parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
    ...
    */
    ...
    //3.请求
    [manager GET:@"192.168.1.123:1200/" parameters:dict success: ^(AFHTTPRequestOperation *operation, id responseObject) {
