...
- (void)initControlBtn {
    UIView *buttonView = [[UIView alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - 50.0f, self.view.frame.size.width, 50)];
    buttonView.backgroundColor = [UIColor blackColor];
    [self.view addSubview:buttonView];
    
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(20, 0, self.view.frame.size.width / 2 - 20, 50)];
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width / 2, 0, self.view.frame.size.width / 2 - 20, 50)];
    ...
    [confirmBtn setContentHorizontalAlignment:UIControlContentHorizontalAlignmentRight];
    confirmBtn.titleLabel.textColor = [UIColor whiteColor];
